...
class PessoaController {
    ...
    static async apagaPessoa(req, res) {
        ...
        try {
            ...
            return res.status(200).json({ mensagem: `Registro de id ${id} removido com sucesso` })
        } catch (error) {
            return res.status(500).json(error.message)
        }
    }
    ...
    static async apagaMatricula(req, res) {
        ...
        try {
            ...
            return res.status(200).json({ mensagem: `Matricula id ${matriculaId} do aluno de id ${estudanteId} removido com sucesso` })
        } catch (error) {
            return res.status(500).json(error.message)
        }
    }
