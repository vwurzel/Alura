...
class EmailRedefinicaoSenha extends Email {
  constructor (usuario, token) {
    ...
    this.text = `Olá! Voce pediu para redefinir sua senha. Use o token a seguir para redefinir sua senha: ${token}`
    this.html = `<h1>Olá!</h1> Voce pediu para redefinir sua senha. Use o token a seguir para redefinir sua senha: ${token}`
  }
}
